    ...
    <div className='container-fluid'>
      <div className='row'>
        <div className='col-md-3'>
          ...
          <input ref={id} placeholder='Video ID' className='w-100 input-style' />
        ...
        <div className='col-md-2'>
          ...
          <img src={xbotPic} className='bot-image col-md-11' onClick={() => setBot(xbot)} alt='Avatar 1' />
          <img src={ybotPic} className='bot-image col-md-11' onClick={() => setBot(ybot)} alt='Avatar 2' />

          <p className='label-style'>Animation Speed: {Math.round(speed * 100) / 100}</p>
          <Slider axis="x" xmin={0.05} xmax={0.50} xstep={0.01} x={speed} onChange={({ x }) => setSpeed(x)} />

          <p className='label-style'>Pause time: {pause} ms</p>
          <Slider axis="x" xmin={0} xmax={2000} xstep={100} x={pause} onChange={({ x }) => setPause(x)} />
        </div>
      </div>
      ...
      <Modal show={invalidId} onHide={() => setInvalidId(false)}>
        ...
        <Modal.Body>
          Please make sure that the video ID that you have entered is valid!
        </Modal.Body>
        <Modal.Footer>
